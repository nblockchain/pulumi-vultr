...
//
// Deprecated: tag has been deprecated and should no longer be used. Instead, use tags
func (o BareMetalServerOutput) Tag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *BareMetalServer) pulumi.StringPtrOutput { return v.Tag }).(pulumi.StringPtrOutput)
}
