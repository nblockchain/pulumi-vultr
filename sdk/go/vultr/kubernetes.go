...
type kubernetesState struct {
	...
	// Contains the default node pool that was deployed.
	NodePools *KubernetesNodePools `pulumi:"nodePools"`
	// The region your VKE cluster will be deployed in. Currently, supported values are `ewr` and `lax`
...
// Contains the default node pool that was deployed.
func (o KubernetesOutput) NodePools() KubernetesNodePoolsPtrOutput {
	return o.ApplyT(func(v *Kubernetes) KubernetesNodePoolsPtrOutput { return v.NodePools }).(KubernetesNodePoolsPtrOutput)
}
