...
// KubernetesNodePoolsInput is an input type that accepts KubernetesNodePoolsArgs and KubernetesNodePoolsOutput values.
// You can construct a concrete instance of `KubernetesNodePoolsInput` via:
//
...
func (i KubernetesNodePoolsArgs) ToKubernetesNodePoolsPtrOutput() KubernetesNodePoolsPtrOutput {
	return i.ToKubernetesNodePoolsPtrOutputWithContext(context.Background())
}
...
func (i KubernetesNodePoolsArgs) ToKubernetesNodePoolsPtrOutputWithContext(ctx context.Context) KubernetesNodePoolsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KubernetesNodePoolsOutput).ToKubernetesNodePoolsPtrOutputWithContext(ctx)
}

// KubernetesNodePoolsPtrInput is an input type that accepts KubernetesNodePoolsArgs, KubernetesNodePoolsPtr and KubernetesNodePoolsPtrOutput values.
// You can construct a concrete instance of `KubernetesNodePoolsPtrInput` via:
//
//          KubernetesNodePoolsArgs{...}
//
//  or:
...
type kubernetesNodePoolsPtrType KubernetesNodePoolsArgs

func KubernetesNodePoolsPtr(v *KubernetesNodePoolsArgs) KubernetesNodePoolsPtrInput {
	return (*kubernetesNodePoolsPtrType)(v)
}

func (*kubernetesNodePoolsPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**KubernetesNodePools)(nil)).Elem()
}

func (i *kubernetesNodePoolsPtrType) ToKubernetesNodePoolsPtrOutput() KubernetesNodePoolsPtrOutput {
	return i.ToKubernetesNodePoolsPtrOutputWithContext(context.Background())
}

func (i *kubernetesNodePoolsPtrType) ToKubernetesNodePoolsPtrOutputWithContext(ctx context.Context) KubernetesNodePoolsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KubernetesNodePoolsPtrOutput)
}
...
func (o KubernetesNodePoolsOutput) ToKubernetesNodePoolsPtrOutput() KubernetesNodePoolsPtrOutput {
	return o.ToKubernetesNodePoolsPtrOutputWithContext(context.Background())
}
...
func (o KubernetesNodePoolsOutput) ToKubernetesNodePoolsPtrOutputWithContext(ctx context.Context) KubernetesNodePoolsPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v KubernetesNodePools) *KubernetesNodePools {
		return &v
	}).(KubernetesNodePoolsPtrOutput)
}

// Enable the auto scaler for the default node pool.
func (o KubernetesNodePoolsOutput) AutoScaler() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v KubernetesNodePools) *bool { return v.AutoScaler }).(pulumi.BoolPtrOutput)
}

// Date node was created.
func (o KubernetesNodePoolsOutput) DateCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KubernetesNodePools) *string { return v.DateCreated }).(pulumi.StringPtrOutput)
}

// Date of node pool updates.
func (o KubernetesNodePoolsOutput) DateUpdated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KubernetesNodePools) *string { return v.DateUpdated }).(pulumi.StringPtrOutput)
}

// ID of node.
func (o KubernetesNodePoolsOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KubernetesNodePools) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// The label to be used as a prefix for nodes in this node pool.
func (o KubernetesNodePoolsOutput) Label() pulumi.StringOutput {
	return o.ApplyT(func(v KubernetesNodePools) string { return v.Label }).(pulumi.StringOutput)
}

// The maximum number of nodes to use with the auto scaler.
func (o KubernetesNodePoolsOutput) MaxNodes() pulumi.IntPtrOutput {
	return o.ApplyT(func(v KubernetesNodePools) *int { return v.MaxNodes }).(pulumi.IntPtrOutput)
}

// The minimum number of nodes to use with the auto scaler.
func (o KubernetesNodePoolsOutput) MinNodes() pulumi.IntPtrOutput {
	return o.ApplyT(func(v KubernetesNodePools) *int { return v.MinNodes }).(pulumi.IntPtrOutput)
}

// The number of nodes in this node pool.
func (o KubernetesNodePoolsOutput) NodeQuantity() pulumi.IntOutput {
	return o.ApplyT(func(v KubernetesNodePools) int { return v.NodeQuantity }).(pulumi.IntOutput)
}

// Array that contains information about nodes within this node pool.
func (o KubernetesNodePoolsOutput) Nodes() KubernetesNodePoolsNodeArrayOutput {
	return o.ApplyT(func(v KubernetesNodePools) []KubernetesNodePoolsNode { return v.Nodes }).(KubernetesNodePoolsNodeArrayOutput)
}

// The plan to be used in this node pool. [See Plans List](https://www.vultr.com/api/#operation/list-plans) Note the minimum plan requirements must have at least 1 core and 2 gbs of memory.
func (o KubernetesNodePoolsOutput) Plan() pulumi.StringOutput {
	return o.ApplyT(func(v KubernetesNodePools) string { return v.Plan }).(pulumi.StringOutput)
}

// Status of node.
func (o KubernetesNodePoolsOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KubernetesNodePools) *string { return v.Status }).(pulumi.StringPtrOutput)
}

// Tag for node pool.
func (o KubernetesNodePoolsOutput) Tag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KubernetesNodePools) *string { return v.Tag }).(pulumi.StringPtrOutput)
}

type KubernetesNodePoolsPtrOutput struct{ *pulumi.OutputState }

func (KubernetesNodePoolsPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**KubernetesNodePools)(nil)).Elem()
}
...
func (o KubernetesNodePoolsPtrOutput) Elem() KubernetesNodePoolsOutput {
	return o.ApplyT(func(v *KubernetesNodePools) KubernetesNodePools {
		if v != nil {
			return *v
		}
...
// Enable the auto scaler for the default node pool.
func (o KubernetesNodePoolsPtrOutput) AutoScaler() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *bool {
		if v == nil {
			return nil
		}
		return v.AutoScaler
...
// Date node was created.
func (o KubernetesNodePoolsPtrOutput) DateCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *string {
		if v == nil {
			return nil
		}
...
// Date of node pool updates.
func (o KubernetesNodePoolsPtrOutput) DateUpdated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *string {
		if v == nil {
			return nil
		}
...
// ID of node.
func (o KubernetesNodePoolsPtrOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *string {
		if v == nil {
			return nil
		}
...
// The label to be used as a prefix for nodes in this node pool.
func (o KubernetesNodePoolsPtrOutput) Label() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *string {
		if v == nil {
			return nil
		}
...
// The maximum number of nodes to use with the auto scaler.
func (o KubernetesNodePoolsPtrOutput) MaxNodes() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *int {
		if v == nil {
			return nil
		}
		return v.MaxNodes
...
// The minimum number of nodes to use with the auto scaler.
func (o KubernetesNodePoolsPtrOutput) MinNodes() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *int {
		if v == nil {
			return nil
		}
...
// The number of nodes in this node pool.
func (o KubernetesNodePoolsPtrOutput) NodeQuantity() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *int {
		if v == nil {
			return nil
		}
...
// Array that contains information about nodes within this node pool.
func (o KubernetesNodePoolsPtrOutput) Nodes() KubernetesNodePoolsNodeArrayOutput {
	return o.ApplyT(func(v *KubernetesNodePools) []KubernetesNodePoolsNode {
		if v == nil {
			return nil
		}
		return v.Nodes
...
// The plan to be used in this node pool. [See Plans List](https://www.vultr.com/api/#operation/list-plans) Note the minimum plan requirements must have at least 1 core and 2 gbs of memory.
func (o KubernetesNodePoolsPtrOutput) Plan() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *string {
		if v == nil {
			return nil
		}
...
// Status of node.
func (o KubernetesNodePoolsPtrOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *string {
		if v == nil {
			return nil
		}
...
// Tag for node pool.
func (o KubernetesNodePoolsPtrOutput) Tag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KubernetesNodePools) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesNodePoolsInput)(nil)).Elem(), KubernetesNodePoolsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KubernetesNodePoolsPtrInput)(nil)).Elem(), KubernetesNodePoolsArgs{})
	...
	pulumi.RegisterOutputType(KubernetesNodePoolsPtrOutput{})
