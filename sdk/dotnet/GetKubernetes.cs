...
namespace Pulumi.Vultr
{
    public static class GetKubernetes
    {
        ...
        public static Task<GetKubernetesResult> InvokeAsync(GetKubernetesArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKubernetesResult>("vultr:index/getKubernetes:getKubernetes", args ?? new GetKubernetesArgs(), options.WithDefaults());
        ...
        public static Output<GetKubernetesResult> Invoke(GetKubernetesInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKubernetesResult>("vultr:index/getKubernetes:getKubernetes", args ?? new GetKubernetesInvokeArgs(), options.WithDefaults());
    }
