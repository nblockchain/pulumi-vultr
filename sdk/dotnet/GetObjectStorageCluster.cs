...
namespace Pulumi.Vultr
{
    public static class GetObjectStorageCluster
    {
        ...
        public static Task<GetObjectStorageClusterResult> InvokeAsync(GetObjectStorageClusterArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetObjectStorageClusterResult>("vultr:index/getObjectStorageCluster:getObjectStorageCluster", args ?? new GetObjectStorageClusterArgs(), options.WithDefaults());
        ...
        public static Output<GetObjectStorageClusterResult> Invoke(GetObjectStorageClusterInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetObjectStorageClusterResult>("vultr:index/getObjectStorageCluster:getObjectStorageCluster", args ?? new GetObjectStorageClusterInvokeArgs(), options.WithDefaults());
    }
