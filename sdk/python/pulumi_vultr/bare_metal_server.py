...
class BareMetalServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tag: (Optional) The tag to assign to the server.
        ...
        if tag is not None:
            warnings.warn("""tag has been deprecated and should no longer be used. Instead, use tags""", DeprecationWarning)
            pulumi.log.warn("""tag is deprecated: tag has been deprecated and should no longer be used. Instead, use tags""")
        if tag is not None:
...
class BareMetalServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if tag is not None and not opts.urn:
                warnings.warn("""tag has been deprecated and should no longer be used. Instead, use tags""", DeprecationWarning)
                pulumi.log.warn("""tag is deprecated: tag has been deprecated and should no longer be used. Instead, use tags""")
