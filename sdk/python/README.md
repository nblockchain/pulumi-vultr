...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `vultr` with the `NAME` of your provider.
...
- binary: pulumi-resource-vultr
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-vultr/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-vultr/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-vultr_darwin_amd64_v1
│   └── pulumi-resource-vultr
├── pulumi-vultr_darwin_arm64
│   └── pulumi-resource-vultr
├── pulumi-vultr_linux_amd64_v1
│   └── pulumi-resource-vultr
├── pulumi-vultr_linux_arm64
│   └── pulumi-resource-vultr
├── pulumi-vultr_windows_amd64_v1
│   └── pulumi-resource-vultr.exe
└── pulumi-vultr_windows_arm64
    └── pulumi-resource-vultr.exe
```
